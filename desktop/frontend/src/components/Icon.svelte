<script lang="ts">
  ...
  let { name, size = 16, color = 'currentColor' }: { name: Name; size?: number; color?: string } = $props()
</script>

<svg width={size} height={size} viewBox="0 0 16 16" fill="none" stroke={color} stroke-width="1.6"
